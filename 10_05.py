...
Фактично ми виконуємо при цьому поліморфізм. Поліморфізм - 
це здатність програми вибирати різні реалізації при виклику операцій з однією і тією ж назвою. 
...
class Cat(Animal):
    ...
    weight = 0
    def __init__(self, nickname, weight):
        type(self).nickname = nickname
        type(self).weight = weight
